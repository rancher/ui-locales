...
8. **MANDATORY — Dispatch verify-translation** — You MUST call the `dispatch_workflow` tool to dispatch the `verify-translation` workflow. This step is NOT optional. Use `dispatch-workflow` with inputs:
